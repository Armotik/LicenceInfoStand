...
export const TRANSITION_INFO = {
  ...
  dispositifs_accompagnement: [
    ...
    {
      nom: 'Module ARP',
      description: 'Accompagnement à la Réussite de mon Projet : orientation, CV, connaissance des métiers.',
      type: 'Obligatoire L1',
      icon: '🎯',
    },
    {
      nom: 'Semaine d\'Intégration',
      description: 'Immersion avant début des cours pour créer du lien social et découvrir le campus.',
      type: 'Début d\'année',
      icon: '🎉',
    },
  ],
