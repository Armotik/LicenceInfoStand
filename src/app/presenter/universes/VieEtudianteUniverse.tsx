      ...
      <div className="flex-1 overflow-y-auto scrollbar-hide">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {activeSection === 'rochelle' && <RochelleSection />}
    ...
    <div className="space-y-10">
      ...
      <div>
        ...
        <motion.div
          ...
          className="mt-6 bg-gradient-to-r from-red-900/30 to-orange-900/20 rounded-2xl p-6 border border-red-500/30"
        >
      ...
      <div>
        <h3 className="text-2xl font-bold text-primary-light mb-6 flex items-center gap-2">
          <span>💻</span> Écosystème Numérique - {ECOSYSTEME_NUMERIQUE.label}
        </h3>
        ...
        <div className="bg-green-900/20 rounded-xl p-5 border border-green-500/30 mb-6">
          <h4 className="font-bold text-green-400 mb-3">🎯 Marché de l'emploi IT</h4>
        ...
        >
          <h4 className="text-xl font-bold text-purple-400 mb-3">
            🎬 {ECOSYSTEME_NUMERIQUE.evenement.nom}
          </h4>
      ...
      >
        ...
        <div className="space-y-4">
          <div className="bg-blue-900/20 rounded-lg p-4 border border-blue-500/30">
            <h4 className="font-bold text-blue-400 mb-2">💻 Agrégateur Carbone Territorial</h4>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-purple-900/20 rounded-lg p-4 border border-purple-500/30">
              <h4 className="font-bold text-purple-400 mb-2">🚗 {LRTZC_INFO.mobilite.objectif}</h4>
            ...
            <div className="bg-cyan-900/20 rounded-lg p-4 border border-cyan-500/30">
              <h4 className="font-bold text-cyan-400 mb-2">🌊 {LRTZC_INFO.carboneBleu.projet}</h4>
